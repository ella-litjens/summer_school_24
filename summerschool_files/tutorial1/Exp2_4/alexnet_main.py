...
parser.add_argument("--data_path", type=str, default='datasets/Caltech15', help="Path to dataset")
parser.add_argument("--save_path", type=str, default='checkpoints', help="Path to save your checkpoints")
parser.add_argument("--model_name", type=str, default='AlexNet', help="Model name. LeNet5 or AlexNet")
